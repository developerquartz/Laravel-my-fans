...
<div class="row">
	...
	<div class="col-sm-2 d-md-block d-none d-sm-none">
		<div class="profilePicSmall mt-0 ml-0 mr-2 mb-2 ml-md-3 profilePicOnlineSm shadow">
			<img src="{{ secure_image($profile->profilePic, 75, 75) }}" alt="" class="img-fluid">
			<!--<img src="http://onlyfans.bestwebdevs.com/public/uploads/{{ $profile->profilePic }}" alt="" class="img-fluid">-->
		</div>
	</div>
	<div class="col-12 col-sm-10" id="belowCreatePost">
		<textarea name="text_content" id="createPost" rows="1" class="form-control" placeholder="@lang('post.writeSomething')" required="required"></textarea>
		...
		<br>
		  ...
		  <div class="row">
          	<div class="col-12 col-sm-12 col-md-8">
				...
				<a href="javascript:void(0);" class="togglePostType noHover d-none" data-switch-to="paid" data-toggle="tooltip" title="@lang('post.freePost')">
					<h5 class="d-inline"><i class="fas fa-lock-open text-success"></i></h5>
				</a>

				<a href="javascript:void(0);" class="togglePostType noHover" data-switch-to="free" data-toggle="tooltip" title="@lang('post.paidPost')">
