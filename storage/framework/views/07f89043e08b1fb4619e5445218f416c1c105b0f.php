...
} elseif ($_instance->childHasBeenRendered('BKGeVGX')) {
    $componentId = $_instance->getRenderedChildComponentId('BKGeVGX');
    $componentTag = $_instance->getRenderedChildComponentTagName('BKGeVGX');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BKGeVGX');
} else {
    $response = \Livewire\Livewire::mount('user-subscribers-list', [ 'subscribers' => $subscribers ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('BKGeVGX', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
