...
<div class="row">
	...
	<div class="col-sm-2 d-md-block d-none d-sm-none">
		<div class="profilePicSmall mt-0 ml-0 mr-2 mb-2 ml-md-3 profilePicOnlineSm shadow">
			...
			<!--<img src="http://onlyfans.bestwebdevs.com/public/uploads/<?php echo e($profile->profilePic); ?>" alt="" class="img-fluid">-->
		</div>
	</div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/onlyfans/public_html/resources/views/posts/create-post.blade.php ENDPATH**/ ?>