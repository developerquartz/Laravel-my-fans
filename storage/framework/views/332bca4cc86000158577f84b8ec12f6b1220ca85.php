        ...
        <div class="col-12 col-sm-12 col-md-6 offset-0 offset-sm-0 offset-md-3">
            <div class="card shadow-sm p-3 mb-3">
                ...
                <div class="alert alert-secondary">
                    <?php echo app('translator')->get('v19.cardAuthDescription', ['amount' => opt('payment-settings.currency_symbol') . $amount]); ?>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('mercadopago-authorization-callback')); ?>">
                    <script
                      ...
                      data-currency_id="<?php echo e(opt('payment-settings.currency_code')); ?>">
                    </script>
                </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/patrons/resources/views/subscribe/mercadopago.blade.php ENDPATH**/ ?>