...
<div class="profilePic <?php if($profile->user->isOnline()): ?> profilePicOnline <?php else: ?> profilePicOffline <?php endif; ?> shadow">
	<a href="<?php echo e($profile->url); ?>">
		...
		<!--<img src="http://onlyfans.bestwebdevs.com/public/uploads/<?php echo e($profile->profilePic); ?>" alt="profile pic" class="img-fluid" style="width:150px;height:150px;">-->
	</a>
</div>
</div>
...
} elseif ($_instance->childHasBeenRendered('7da0SQX')) {
    $componentId = $_instance->getRenderedChildComponentId('7da0SQX');
    $componentTag = $_instance->getRenderedChildComponentTagName('7da0SQX');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7da0SQX');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('7da0SQX', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlyfans/public_html/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>