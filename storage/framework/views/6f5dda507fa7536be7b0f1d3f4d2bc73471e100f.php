	...
	<div class="col-12 col-sm-12 col-md-6 offset-0 offset-sm-0 offset-md-3">
		<div class="card shadow-sm">
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" name="paypalform" id="paypalform">
                ...
                <input type="hidden" name="return" value="<?php echo e(route('messages.inbox')); ?>" />
                <input type="hidden" name="cancel_return" value="<?php echo e(route('messages.inbox')); ?>"/>
                <input type="hidden" name="notify_url" value="<?php echo e(route('paypalUnlockIpn', ['message' => $message->id])); ?>"/>
                ...
                <input type="hidden" name="amount" value="<?php echo e($lockPrice); ?>"/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/patrons/resources/views/messages/paypal-unlocking.blade.php ENDPATH**/ ?>