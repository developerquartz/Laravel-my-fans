...
} elseif ($_instance->childHasBeenRendered('Ru93XXW')) {
    $componentId = $_instance->getRenderedChildComponentId('Ru93XXW');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ru93XXW');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ru93XXW');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('Ru93XXW', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
