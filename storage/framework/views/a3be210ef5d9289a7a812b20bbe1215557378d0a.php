...
<div class="box">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="/admin/content-moderation/delete-report/<?php echo e($r->id); ?>" class="text-danger" onclick="return confirm('Delete report?')">
                    Delete
                </a>
            </td>
        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlyfans/public_html/resources/views/admin/content-moderation.blade.php ENDPATH**/ ?>