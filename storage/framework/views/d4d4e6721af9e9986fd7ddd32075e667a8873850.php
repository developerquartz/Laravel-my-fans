...
} elseif ($_instance->childHasBeenRendered('Nxirwqw')) {
    $componentId = $_instance->getRenderedChildComponentId('Nxirwqw');
    $componentTag = $_instance->getRenderedChildComponentTagName('Nxirwqw');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Nxirwqw');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('Nxirwqw', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
