...
} elseif ($_instance->childHasBeenRendered('S3r9RSa')) {
    $componentId = $_instance->getRenderedChildComponentId('S3r9RSa');
    $componentTag = $_instance->getRenderedChildComponentTagName('S3r9RSa');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S3r9RSa');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('S3r9RSa', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/onlyfans/public_html/resources/views/messages/inbox.blade.php ENDPATH**/ ?>